...
gallery:
  - label: Living Room
    large: true
    alt: Bright living room with a light grey tufted sofa, round wire-base coffee table on a mauve-and-grey abstract rug, wall-mounted TV above a dark wood console, floor-to-ceiling windows with grey-purple drapes, and decorative wall panelling.
    file: living-room-full.webp
  - label: Sofa & Lounge Area
    alt: Close-up of the seating corner with a light grey tufted three-seater sofa, layered mauve and charcoal throw pillows, a rustic wooden world map artwork, and a large potted plant beside sheer curtains.
    file: sofa-area.webp
  - label: Dining & Kitchen
    alt: Dark wood dining table with four grey-upholstered chairs beneath three white pendant lights, glossy white kitchen cabinetry with glass backsplash, and terrazzo flooring.
    file: dining-kitchen.webp
  - label: Master Bedroom
    alt: Master bedroom with warm mustard-yellow panelled walls, a queen bed with dark navy upholstered headboard, floral canvas artwork, and rich hardwood flooring.
